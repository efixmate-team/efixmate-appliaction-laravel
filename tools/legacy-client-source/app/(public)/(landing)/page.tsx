...
import type { HomePageViewProps, EmergencyServiceItem, TechnicianBannerProps } from "./HomePageView";
import { LandingChromeProvider } from "./_components/LandingChromeProvider";
import { DEFAULT_FOOTER_VISIBILITY } from "./_components/LandingChromeProvider";
import HomeAuthShell from "./_components/HomeAuthShell";
...
const DEFAULT_CHROME = {
  ...
  brandDescription: "Trusted service experts for homes, offices & workplaces — verified technicians, transparent pricing, and guaranteed satisfaction.",
...
export default async function App() {
  ...
  const hero        = m["home.hero"]           as Partial<HomePageViewProps["hero"]>                             | undefined;
  const rating      = m["home.rating"]         as HomePageViewProps["rating"]                                    | undefined;
  const cBanner     = m["home.contact_banner"] as Partial<HomePageViewProps["contactBanner"]>                   | undefined;
  const serviceCards = m["home.service_cards"] as HomePageViewProps["serviceCards"]                              | undefined;
  const promiseItems = m["home.promise_items"] as HomePageViewProps["promiseItems"]                              | undefined;
  const steps       = m["home.steps"]          as HomePageViewProps["steps"]                                     | undefined;
  const customerTypes = m["home.customer_types"] as HomePageViewProps["customerTypes"]                           | undefined;
  const testimonials = m["home.testimonials"]  as HomePageViewProps["testimonials"]                              | undefined;
  ...
  const emergencyServices    = m["home.emergency_services"]    as EmergencyServiceItem[]    | undefined;
  const technicianBanner     = m["home.technician_banner"]     as TechnicianBannerProps     | undefined;
  ...
  // Top 8 services × all cities — drives crawl depth into /{city}/{service} pages.
  return (
